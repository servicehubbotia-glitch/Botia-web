...
(() => {
  ...
  const UI_TEXT = {
    ...
    ar: { detected: "ما الذي اكتشفه BOTIA", matters: "لماذا يهم", cannot: "حدود الملصق", sources: "السياق", note: "ملاحظة", disclaimer: "تقدّم BOTIA معلومات بناءً على المكوّنات المقروءة على الملصق.", more_info: "مزيد من المعلومات عن", what_is: "ما هو", why_botia: "لماذا تشير إليه BOTIA", can: "ما تستطيع BOTIA فعله", cannot_do: "ما لا تستطيع BOTIA فعله", sources_title: "المصادر", back: "العودة →", select_language: "اختر اللغة" },
    zh: { detected: "BOTIA检测到的内容", matters: "为什么重要", cannot: "标签的限制", sources: "背景", note: "说明", disclaimer: "BOTIA基于标签上读取到的配料提供信息。", more_info: "了解更多关于", what_is: "它是什么", why_botia: "为什么BOTIA会标记它", can: "BOTIA可以", cannot_do: "BOTIA不可以", sources_title: "来源", back: "← 返回", select_language: "选择语言" },
    ...
    id: { detected: "Apa yang dideteksi BOTIA", matters: "Mengapa ini penting", cannot: "Batas label", sources: "Konteks", note: "Catatan", disclaimer: "BOTIA memberikan informasi berdasarkan bahan yang terbaca pada label.", more_info: "Informasi lebih lanjut tentang", what_is: "Apa itu", why_botia: "Mengapa BOTIA menandainya", can: "BOTIA DAPAT", cannot_do: "BOTIA TIDAK DAPAT", sources_title: "Sumber", back: "← Kembali", select_language: "Pilih bahasa" }
  };
  const NAV_TEXT = {
